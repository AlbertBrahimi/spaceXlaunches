...
export function useGetMissionsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetMissionsQuery, GetMissionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetMissionsQuery, GetMissionsQueryVariables>(GetMissionsDocument, options);
        }
...
export type GetMissionsSuspenseQueryHookResult = ReturnType<typeof useGetMissionsSuspenseQuery>;
